...
function PostCard({
  ...
  const [preventNavLink, setpreventNavLink] = useState(false);
    ...
    <>
        ...
        >
          {location.pathname === "/allPosts" ? (
            <div className="flex cursor-pointer  justify-center items-center flex-col  w-[50px] absolute left-[5px] top-[10px] tablet:relative tablet:mb-[20px] hover:scale-[1.1] transition-all duration-200" onClick={(e) => toUserCard(e)}>
              <FaUser color="gray" />
          ...
          <div className="max-w-[600px] flex  flex-col tablet:items-center ">
            ...
            <div
              className="flex items-center  w-full ml-[0px] mt-[5px] tablet:justify-center " 
